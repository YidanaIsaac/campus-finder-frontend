...
const Login = () => {
  ...
  const [userType, setUserType] = useState('student'); // student, staff, visitor, security
  ...
  const handleSubmit = (e) => {
    ...
    if (isSignUp) {
      ...
      if (userType === 'staff' && !formData.staffId) {
        alert('Staff ID is required for staff');
        return;
      }
      if (userType === 'security' && !formData.securityId) {
        alert('Security ID is required for security personnel');
        return;
      }
      ...
      // Login validation
      let loginField = formData.email;
      if (userType === 'student') loginField = formData.studentId;
      if (userType === 'staff') loginField = formData.staffId;
      if (userType === 'security') loginField = formData.securityId;
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      {/* Header Section */}
      <div className="bg-gradient-to-br from-primary to-primary-dark text-white pt-12 pb-16 px-6 rounded-b-3xl">
      ...
      <div className="flex-1 px-6 -mt-8 pb-6">
        ...
        <div className="mt-8 mb-6 text-center">
          ...
          <button className="flex items-center justify-center gap-2 text-gray-700 hover:text-primary transition-colors mx-auto mb-3">
            <Phone className="w-4 h-4" />
            <span className="text-sm font-medium">Contact IT Support</span>
          </button>

          <button className="flex items-center justify-center gap-2 text-gray-700 hover:text-primary transition-colors mx-auto">
